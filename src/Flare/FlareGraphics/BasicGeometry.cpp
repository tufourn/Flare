...
MeshBuffers createCubeMesh(float edgeX, float edgeY, float edgeZ) {
  ...
  meshBuffers.positions = {
      p[1], p[0], p[3], p[2], p[4], p[5], p[6], p[7], p[0], p[4], p[7], p[3],
      p[5], p[1], p[2], p[6], p[0], p[1], p[5], p[4], p[7], p[6], p[2], p[3],
  };

  meshBuffers.normals = {
      n[0], n[0], n[0], n[0], n[1], n[1], n[1], n[1], n[2], n[2], n[2], n[2],
      n[3], n[3], n[3], n[3], n[4], n[4], n[4], n[4], n[5], n[5], n[5], n[5],
  };

  meshBuffers.uvs = {
      uvs[0], uvs[1], uvs[2], uvs[3], uvs[0], uvs[1], uvs[2], uvs[3],
      uvs[0], uvs[1], uvs[2], uvs[3], uvs[0], uvs[1], uvs[2], uvs[3],
      uvs[0], uvs[1], uvs[2], uvs[3], uvs[0], uvs[1], uvs[2], uvs[3],
  };
