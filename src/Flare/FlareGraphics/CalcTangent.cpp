...
namespace Flare {
    ...
    int CalcTangent::getVertexIndex(const SMikkTSpaceContext *pContext, int iFace, int iVert) {
    ...
    int CalcTangent::getNumVerticesOfFace(const SMikkTSpaceContext *pContext, const int iFace) {
